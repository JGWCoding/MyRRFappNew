...
public class DialogUtils {
    ...
    public static void alertDialog(String PositiveText,String NegativeText,Context context, String title, String message,boolean isCancel, final Runnable task) {
